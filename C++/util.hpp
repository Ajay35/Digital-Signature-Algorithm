...
ll power(ll,ll);//done
ll get_prime();
bool is_prime(ll,ll);//done
ll get_primitive(ll);//done
ll gcdExtended(ll a, ll b, ll *x, ll *y);//done
ll modInverse(ll a,ll m) ;//done
bool miller_primality_test(ll,ll);//done
